...
def estimate_tempo(audio_file, ground_truth_file, genre_file):
    ...
    # Load audio file
    signal, sample_rate = madmom.io.audio.load_audio_file(audio_file)
    ...
    predicted_tempo = tempo_processor(beats)[0][0].item()  # Extract the scalar value

    # Read ground truth tempo from file
